...
export function CoverImage({
  ...
  return (
    // eslint-disable-next-line @next/next/no-img-element -- remote covers from
    // five external CDNs; next/image would need a remotePatterns allowlist and
    // an optimizer pass that adds nothing for one-admin self-hosting.
    <img
      src={src}
      alt={alt}
      loading="lazy"
